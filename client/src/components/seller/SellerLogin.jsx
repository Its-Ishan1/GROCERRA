...
const SellerLogin = () => {
  ...
  return  !isSeller &&(
   <form onSubmit={onSubmitHandler} className='min-h-screen flex items-center text-smtext-gray-600'>
    ...
    <p className='text-2xl font-medium m-auto'> <span className='text-primary'>
        ...
        <div className='w-full'>
         ...
         <div className='w-full'>
            ...
            <button className='bg-primary text-white  w-full py-2 rounded-md cursor-pointer mt-8'> Login</button>
